...
import { FaHome, FaInfoCircle, FaQuestionCircle, FaSearch, FaShoppingCart, FaUser } from "react-icons/fa";
    ...
    return (
        <>
            <div className="w-full bg-primary text-white flex justify-between items-center py-4 px-10 lg:px-16 fixed top-0 right-0">
                <Link to="/">
                    <h1 className="font-bold sm:text-lg md:text-xl">Bhojan Bazaar<span className="text-secondary text-xs md:text-xs font-chango">Good Food Made Easy</span></h1>
                </Link>
